    ...
    <div className=" mx-5 md:mx-40 my-20">
      ...
      <div className="flex flex-col md:flex-row my-5">
        <div className="md:w-1/2">
          <h1 className="font-bold">Sandeep yadav</h1>
          <h1>
          ...
          <div className="flex flex-row">
            <div className="mt-4 mx-2">
              <Link href={"https://twitter.com/sandeepyadav_24"}>
                <svg
                  className="w-6 h-6 text-[#5740B9] dark:text-white"
                  aria-hidden="true"
            ...
            <div className="my-3 mx-2">
              ...
              >
                <svg
                  className="w-[32px] h-[32px] text-[#5740B9] dark:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div className="my-3 mx-2">
              <Link href={"https://github.com/sandeepyadav-24"}>
                <svg
                  className="w-6 h-6 text-[#5740B9] dark:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mt-4 mx-2">
              <Link href={"sandeepyadav004343@gmail.com"}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-6 h-6 text-[#5740B9]"
                >
                  <path
                    fillRule="evenodd"
      ...
      <hr />
      <h1 className="my-5">
        Copyright @2024 Sandeep Yadav. All Right Reserved
      </h1>
    </div>
  );
};
